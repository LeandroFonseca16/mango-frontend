...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Cores base do sistema (CSS Variables para temas dinâmicos)
        ...
        // Paleta Mango - Cores tropicais customizadas
        mango: {
          ...
          400: '#FB923C',  // Médio
          500: '#FF8C00',  // Principal - Laranja vibrante da manga
          600: '#EA580C',  // Escuro
          700: '#C2410C',  // Mais escuro
          800: '#9A3412',  // Muito escuro
          900: '#7C2D12',  // Super escuro
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
